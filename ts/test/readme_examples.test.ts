...
//     (\`new NeugeborenenVornamenKantonStgallenSDK(...)\` / \`NeugeborenenVornamenKantonStgallenSDK.test(...)\` become
//     \`NeugeborenenVornamenKantonStgallenSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const SDK_NAME = 'NeugeborenenVornamenKantonStgallenSDK'
...
const TEST_SEED = {"entity":{"metadata":{"test01":{"id":"test01"}},"record":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new NeugeborenenVornamenKantonStgallenSDK(...)\` and any
// \`NeugeborenenVornamenKantonStgallenSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+NeugeborenenVornamenKantonStgallenSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/NeugeborenenVornamenKantonStgallenSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
