# NeugeborenenVornamenKantonStgallen TypeScript SDK



The TypeScript SDK for the NeugeborenenVornamenKantonStgallen API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Metadata()` — each with a small set of operations (`list`)
...
```ts
new NeugeborenenVornamenKantonStgallenSDK(options?: {
  base?: string
  prefix?: string
  suffix?: string
...
| `tester(testopts?, sdkopts?)` | `NeugeborenenVornamenKantonStgallenSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `NeugeborenenVornamenKantonStgallenSDK.test(testopts?, sdkopts?)` | `NeugeborenenVornamenKantonStgallenSDK` | Create a test-mode client. |
...
| `client` | `client(): NeugeborenenVornamenKantonStgallenSDK` | Return the parent SDK client. |
...
├── src/
│   ├── NeugeborenenVornamenKantonStgallenSDK.ts        # Main SDK class
