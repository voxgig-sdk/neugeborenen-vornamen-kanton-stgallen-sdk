...
const NeugeborenenVornamenKantonStgallenError_1 = require("./NeugeborenenVornamenKantonStgallenError");
...
class Context {
    ...
    error(code, msg) {
        return new NeugeborenenVornamenKantonStgallenError_1.NeugeborenenVornamenKantonStgallenError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
