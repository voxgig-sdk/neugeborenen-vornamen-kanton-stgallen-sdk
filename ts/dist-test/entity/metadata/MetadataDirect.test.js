...
(0, node_test_1.describe)('MetadataDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-metadata', async (t) => {
        ...
        const result = await client.direct({
            path: 'explore/v2.1/catalog/datasets/vornamen-der-neugeborenen-kanton-stgallen-seit-1987',
            method: 'GET',
            params,
            query,
        });
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NEUGEBORENEN_VORNAMEN_KANTON_STGALLEN_TEST_METADATA_ENTID'];
