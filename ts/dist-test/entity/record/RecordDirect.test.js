...
(0, node_test_1.describe)('RecordDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.NeugeborenenVornamenKantonStgallenSDK({
    ...
    (0, node_test_1.test)('direct-list-record', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-record', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
        const result = await client.direct({
            path: 'explore/v2.1/catalog/datasets/vornamen-der-neugeborenen-kanton-stgallen-seit-1987/records',
            method: 'GET',
            params,
            query,
        });
...
function liveScenariosActive() { return false && process.env.NEUGEBORENEN_VORNAMEN_KANTON_STGALLEN_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.NeugeborenenVornamenKantonStgallenSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['NEUGEBORENEN_VORNAMEN_KANTON_STGALLEN_TEST_RECORD_ENTID'];
    ...
    const client = new __1.NeugeborenenVornamenKantonStgallenSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=RecordDirect.test.js.map