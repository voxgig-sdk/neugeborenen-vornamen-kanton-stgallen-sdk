...
func envOverride(m map[string]any) map[string]any {
	if os.Getenv("NEUGEBORENENVORNAMENKANTONSTGALLEN_TEST_LIVE") == "TRUE" ||
		os.Getenv("NEUGEBORENENVORNAMENKANTONSTGALLEN_TEST_OVERRIDE") == "TRUE" {
		for key := range m {
	...
	if explain := os.Getenv("NEUGEBORENENVORNAMENKANTONSTGALLEN_TEST_EXPLAIN"); explain != "" {
