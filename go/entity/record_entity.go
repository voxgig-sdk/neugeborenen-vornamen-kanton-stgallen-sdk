...
type RecordEntity struct {
	name    string
	client  *core.NeugeborenenVornamenKantonStgallenSDK
...
func NewRecordEntity(client *core.NeugeborenenVornamenKantonStgallenSDK, entopts map[string]any) *RecordEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RecordEntity) GetName() string { return e.name }
...
func (e *RecordEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RecordEntity) Deleted() bool {
	return e.deleted
}


func (e *RecordEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRecordEntity(e.client, opts)
}

func (e *RecordEntity) Data(args ...any) any {
...
func (e *RecordEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Record; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RecordEntity) DataTyped(data ...Record) Record {
	if len(data) > 0 {
		return typedFrom[Record](e.Data(asMap(data[0])))
	}
	return typedFrom[Record](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Record (all fields
// optional at the wire level).
func (e *RecordEntity) MatchTyped(match ...Record) Record {
	if len(match) > 0 {
		return typedFrom[Record](e.Match(asMap(match[0])))
	}
	return typedFrom[Record](e.Match())
}
...
func (e *RecordEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RecordEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RecordEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RecordListMatch and returns []Record. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RecordEntity) ListTyped(reqmatch RecordListMatch, ctrl map[string]any) ([]Record, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Record](res), nil
}



func (e *RecordEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RecordEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RecordEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RecordEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
