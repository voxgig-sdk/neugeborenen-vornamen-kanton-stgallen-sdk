// Command NeugeborenenVornamenKantonStgallen-mcp is an MCP server exposing the NeugeborenenVornamenKantonStgallen
// SDK as MCP tools.
//
// Two tools are registered:
//
//	NeugeborenenVornamenKantonStgallen_list  — list records of an entity
//	NeugeborenenVornamenKantonStgallen_load  — load a single record of an entity
//
