...
type Args struct {
	Entity string         `json:"entity" jsonschema:"metadata | record"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.NeugeborenenVornamenKantonStgallenSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "neugeborenen-vornamen-kanton-stgallen_list",
		Description: "List records from NeugeborenenVornamenKantonStgallen. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "neugeborenen-vornamen-kanton-stgallen_load",
		Description: "Load a single record from NeugeborenenVornamenKantonStgallen. " +
...
func runOp(client *sdk.NeugeborenenVornamenKantonStgallenSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.NeugeborenenVornamenKantonStgallenSDK, name string) (sdk.NeugeborenenVornamenKantonStgallenEntity, error) {
