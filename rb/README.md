...
The Ruby SDK for the NeugeborenenVornamenKantonStgallen API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.NeugeborenenVornamenKantonStgallen(nil).load(
  { "id" => "test01" }, nil
)
