# NeugeborenenVornamenKantonStgallen SDK Metadata entity
...
class MetadataEntity
  ...
  # @return [Array<Metadata>, Array] the matching Metadata items; raises NeugeborenenVornamenKantonStgallenError on failure
