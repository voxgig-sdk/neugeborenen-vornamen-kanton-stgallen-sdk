# NeugeborenenVornamenKantonStgallen SDK — README + REFERENCE example snippet tests.
#
...
#      (NeugeborenenVornamenKantonStgallenSDK.test) seeded with an in-memory fixture for every
