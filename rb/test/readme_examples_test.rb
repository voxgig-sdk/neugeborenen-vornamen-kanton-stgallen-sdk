...
#      offline in seeded test mode (NeugeborenenVornamenKantonStgallenSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "NeugeborenenVornamenKantonStgallen_sdk.rb")
  SDK_CLASS = "NeugeborenenVornamenKantonStgallenSDK"
  ...
  SDK_BASE = "NeugeborenenVornamenKantonStgallen_sdk"
