...
class MetadataEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set NEUGEBORENEN_VORNAMEN_KANTON_STGALLEN_TEST_METADATA_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def metadata_basic_setup(extra)
  ...
  entid_env_raw = ENV["NEUGEBORENEN_VORNAMEN_KANTON_STGALLEN_TEST_METADATA_ENTID"]
  ...
  idmap_resolved = Helpers.to_map(
    env["NEUGEBORENEN_VORNAMEN_KANTON_STGALLEN_TEST_METADATA_ENTID"])
