...
class MetadataEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set NEUGEBORENENVORNAMENKANTONSTGALLEN_TEST_METADATA_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def metadata_basic_setup(extra)
  ...
  entid_env_raw = ENV["NEUGEBORENENVORNAMENKANTONSTGALLEN_TEST_METADATA_ENTID"]
  ...
  idmap_resolved = Helpers.to_map(
    env["NEUGEBORENENVORNAMENKANTONSTGALLEN_TEST_METADATA_ENTID"])
