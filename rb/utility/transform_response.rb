# NeugeborenenVornamenKantonStgallen SDK utility: transform_response
...
module NeugeborenenVornamenKantonStgallenUtilities
  TransformResponse = ->(ctx) {
    ...
    transform = NeugeborenenVornamenKantonStgallenHelpers.to_map(VoxgigStruct.getprop(point, "transform"))
