...
describe("RecordDirect", function()
  it("should direct-list-record", function()
    local setup = record_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-record", setup.live and "live" or "unit")
...
function record_direct_setup(mockres)
