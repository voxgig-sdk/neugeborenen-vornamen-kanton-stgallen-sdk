...
|---|---|---|
| `ts/` | @voxgig-sdk/neugeborenen-vornamen-kanton-stgallen-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/neugeborenen-vornamen-kanton-stgallen-sdk \
      --repository voxgig-sdk/neugeborenen-vornamen-kanton-stgallen-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/neugeborenen-vornamen-kanton-stgallen-sdk` shows it, and
`npm trust revoke @voxgig-sdk/neugeborenen-vornamen-kanton-stgallen-sdk --id=<id>` removes it.
