...
// NeugeborenenVornamenKantonStgallen SDK feature test
//
...
class FtCtrl extends NeugeborenenVornamenKantonStgallenControl
{
...
class FtClient
{
    ...
    private NeugeborenenVornamenKantonStgallenUtility $utility;

    public function __construct(NeugeborenenVornamenKantonStgallenUtility $utility, array $options)
    {
    ...
    public function get_utility(): NeugeborenenVornamenKantonStgallenUtility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (NeugeborenenVornamenKantonStgallenContext $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public NeugeborenenVornamenKantonStgallenContext $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (NeugeborenenVornamenKantonStgallenContext $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = NeugeborenenVornamenKantonStgallenConfig::make_feature($name);
    ...
    private static function buildUrl(NeugeborenenVornamenKantonStgallenSpec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof NeugeborenenVornamenKantonStgallenError) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new NeugeborenenVornamenKantonStgallenResponse($fetched);
        }
    ...
    private function fail(NeugeborenenVornamenKantonStgallenContext $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (NeugeborenenVornamenKantonStgallenContext $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;
