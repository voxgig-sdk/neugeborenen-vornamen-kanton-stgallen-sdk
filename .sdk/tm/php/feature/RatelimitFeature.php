...
// NeugeborenenVornamenKantonStgallen SDK ratelimit feature
...
class NeugeborenenVornamenKantonStgallenRatelimitFeature extends NeugeborenenVornamenKantonStgallenBaseFeature
{
    ...
    private function _acquire(NeugeborenenVornamenKantonStgallenContext $ctx): void
    {
    ...
    private function _track(NeugeborenenVornamenKantonStgallenContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
