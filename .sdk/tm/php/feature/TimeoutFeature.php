...
// NeugeborenenVornamenKantonStgallen SDK timeout feature
...
class NeugeborenenVornamenKantonStgallenTimeoutFeature extends NeugeborenenVornamenKantonStgallenBaseFeature
{
    ...
    private function _with_timeout(NeugeborenenVornamenKantonStgallenContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NeugeborenenVornamenKantonStgallenContext $_ctx, float $ms): void
    {
        $client = $this->client;
