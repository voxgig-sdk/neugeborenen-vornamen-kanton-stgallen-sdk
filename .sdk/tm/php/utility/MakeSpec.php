...
// NeugeborenenVornamenKantonStgallen SDK utility: make_spec

require_once __DIR__ . '/Graphql.php';

require_once __DIR__ . '/../core/Spec.php';

class NeugeborenenVornamenKantonStgallenMakeSpec
{
    public static function call(NeugeborenenVornamenKantonStgallenContext $ctx): array
    {
        ...
        if ('graphql' === \Voxgig\Struct\Struct::getprop($point, 'kind')) {
            ...
            $ctx->spec->query = [];
            $ctx->spec->headers['content-type'] = NeugeborenenVornamenKantonStgallenGraphql::CONTENT_TYPE;
        } else {
