...
AQL-driven command-line client **and** interactive REPL for the NeugeborenenVornamenKantonStgallen
...
- `<entity>` is a bareword, auto-quoted as an AQL atom (e.g. `metadata`).
