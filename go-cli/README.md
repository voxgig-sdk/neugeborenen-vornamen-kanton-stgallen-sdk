...
AQL-driven CLI and REPL for the NeugeborenenVornamenKantonStgallen SDK. Positional arguments are
...
```sh
go build -o neugeborenen-vornamen-kanton-stgallen-cli ./...
```
...
./neugeborenen-vornamen-kanton-stgallen-cli load 1 metadata
./neugeborenen-vornamen-kanton-stgallen-cli load '{id:1}' metadata
