# neugeborenen-vornamen-kanton-stgallen-cli

boru-driven command-line client **and** interactive REPL for the NeugeborenenVornamenKantonStgallen
...
```sh
# 1. Build a native binary (-> dist/<os>-<arch>/neugeborenen-vornamen-kanton-stgallen-cli)
make build

# 2. See usage (words, entities, env vars)
./neugeborenen-vornamen-kanton-stgallen-cli --help
...
./neugeborenen-vornamen-kanton-stgallen-cli list metadata
./neugeborenen-vornamen-kanton-stgallen-cli list record

# 5. Override the API base URL for a single call
NEUGEBORENEN_VORNAMEN_KANTON_STGALLEN_BASE=https://api.example.com ./neugeborenen-vornamen-kanton-stgallen-cli list metadata

# 6. No arguments -> interactive REPL
./neugeborenen-vornamen-kanton-stgallen-cli
neugeborenen-vornamen-kanton-stgallen> list metadata
neugeborenen-vornamen-kanton-stgallen> /quit
```
...
1. **Build the binary.** From this `go-cli/` directory:
   ...
   ```sh
   make build          # -> dist/<os>-<arch>/neugeborenen-vornamen-kanton-stgallen-cli
   ```
...
3. **Run a query.** Evaluate an boru expression against the API (or run with no
   ...
   ```sh
   ./dist/*/neugeborenen-vornamen-kanton-stgallen-cli list metadata
   ```
...
Run with no arguments to open a REPL (prompt `neugeborenen-vornamen-kanton-stgallen>`). Each line is
evaluated as its own boru expression:

```text
$ ./neugeborenen-vornamen-kanton-stgallen-cli
neugeborenen-vornamen-kanton-stgallen> list metadata
neugeborenen-vornamen-kanton-stgallen> /help
neugeborenen-vornamen-kanton-stgallen> /quit
```
...
- `<entity>` is a bareword, auto-quoted as an boru atom (e.g. `metadata`).
...
| Target | Result |
|--------|--------|
| `make build` | Native binary at `dist/<os>-<arch>/neugeborenen-vornamen-kanton-stgallen-cli`. |
...
(`./neugeborenen-vornamen-kanton-stgallen-cli <expr>`) and interactively (the REPL), and expressions compose the
