...
func registerSDKWords(r *eng.Registry, client *sdk.NeugeborenenVornamenKantonStgallenSDK) {
...
func runOp(client *sdk.NeugeborenenVornamenKantonStgallenSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
