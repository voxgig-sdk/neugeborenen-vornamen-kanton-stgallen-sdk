// Command NeugeborenenVornamenKantonStgallen-cli is a CLI + REPL for the NeugeborenenVornamenKantonStgallen SDK,
...
const prompt = "neugeborenen-vornamen-kanton-stgallen"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "metadata record"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      NEUGEBORENEN_VORNAMEN_KANTON_STGALLEN_APIKEY (api key), NEUGEBORENEN_VORNAMEN_KANTON_STGALLEN_BASE (base url override)")
