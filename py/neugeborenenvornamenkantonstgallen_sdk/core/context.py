...
from neugeborenenvornamenkantonstgallen_sdk.core.helpers import get_ctx_prop, to_map
...
class NeugeborenenVornamenKantonStgallenContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = NeugeborenenVornamenKantonStgallenControl()
        ...
        if isinstance(sp, NeugeborenenVornamenKantonStgallenSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, NeugeborenenVornamenKantonStgallenResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, NeugeborenenVornamenKantonStgallenResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return NeugeborenenVornamenKantonStgallenOperation({})
    ...
    def make_error(self, code, msg):
        return NeugeborenenVornamenKantonStgallenError(code, msg, self)
