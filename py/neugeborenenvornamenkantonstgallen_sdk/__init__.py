...
from neugeborenenvornamenkantonstgallen_sdk.utility import register

# Load features
from neugeborenenvornamenkantonstgallen_sdk.feature.base_feature import NeugeborenenVornamenKantonStgallenBaseFeature
from neugeborenenvornamenkantonstgallen_sdk.features import _has_feature, _make_feature
...
class NeugeborenenVornamenKantonStgallenSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = NeugeborenenVornamenKantonStgallenUtility()
        self._utility = utility

        from neugeborenenvornamenkantonstgallen_sdk.config import shared_config
    ...
    def get_utility(self):
        return NeugeborenenVornamenKantonStgallenUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("NeugeborenenVornamenKantonStgallenSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Metadata(self, data=None) -> "MetadataEntity":
        ...
        from neugeborenenvornamenkantonstgallen_sdk.entity.metadata_entity import MetadataEntity
    ...
    def Record(self, data=None) -> "RecordEntity":
        ...
        from neugeborenenvornamenkantonstgallen_sdk.entity.record_entity import RecordEntity
