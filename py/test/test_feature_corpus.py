...
def _client(kase):
    ...
    NeugeborenenVornamenKantonStgallenSDK(...), not NeugeborenenVornamenKantonStgallenSDK.test(...): the `test` feature is
    ...
    return NeugeborenenVornamenKantonStgallenSDK(opts)
