...
// NeugeborenenVornamenKantonStgallen SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = NeugeborenenVornamenKantonStgallenOmni::makeStructRunner(
    ...
    {
        return NeugeborenenVornamenKantonStgallenOmni::objmodel(NeugeborenenVornamenKantonStgallenOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return NeugeborenenVornamenKantonStgallenOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return NeugeborenenVornamenKantonStgallenOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(NeugeborenenVornamenKantonStgallenOmni::structfix($now, Struct::undef()))
                        !== json_encode(NeugeborenenVornamenKantonStgallenOmni::structfix($val, Struct::undef()))) {
