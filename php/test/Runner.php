...
class NeugeborenenVornamenKantonStgallenTestRunner
{
    ...
    {
        $live = self::getenv('NEUGEBORENEN_VORNAMEN_KANTON_STGALLEN_TEST_LIVE');
        $override = self::getenv('NEUGEBORENEN_VORNAMEN_KANTON_STGALLEN_TEST_OVERRIDE');
        ...
        $explain = self::getenv('NEUGEBORENEN_VORNAMEN_KANTON_STGALLEN_TEST_EXPLAIN');
...
class_alias('NeugeborenenVornamenKantonStgallenTestRunner', 'Runner');
class_alias('NeugeborenenVornamenKantonStgallenHelpers', 'Helpers');
