...
class NeugeborenenVornamenKantonStgallenTestRunner
{
    ...
    {
        $live = self::getenv('NEUGEBORENENVORNAMENKANTONSTGALLEN_TEST_LIVE');
        $override = self::getenv('NEUGEBORENENVORNAMENKANTONSTGALLEN_TEST_OVERRIDE');
        ...
        $explain = self::getenv('NEUGEBORENENVORNAMENKANTONSTGALLEN_TEST_EXPLAIN');
