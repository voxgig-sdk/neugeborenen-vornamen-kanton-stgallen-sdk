...
class RecordDirectTest extends TestCase
{
    public function test_direct_list_record(): void
    {
        $setup = record_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-record", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
