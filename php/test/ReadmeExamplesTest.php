...
// NeugeborenenVornamenKantonStgallen SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NeugeborenenVornamenKantonStgallenSDK::test)
...
{
    private const SDK_CLASS = 'NeugeborenenVornamenKantonStgallenSDK';
    ...
    private const SDK_BASE = 'neugeborenenvornamenkantonstgallen_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../neugeborenenvornamenkantonstgallen_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
