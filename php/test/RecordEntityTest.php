...
class RecordEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = NeugeborenenVornamenKantonStgallenSDK::test($seed, null);
        $seen = iterator_to_array($base->Record(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->Record(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set NEUGEBORENEN_VORNAMEN_KANTON_STGALLEN_TEST_RECORD_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function record_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("NEUGEBORENEN_VORNAMEN_KANTON_STGALLEN_TEST_RECORD_ENTID");
