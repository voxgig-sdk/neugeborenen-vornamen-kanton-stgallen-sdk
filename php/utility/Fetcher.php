...
// NeugeborenenVornamenKantonStgallen SDK utility: fetcher

class NeugeborenenVornamenKantonStgallenFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NeugeborenenVornamenKantonStgallenSDK/1.0)';
    ...
    public static function call(NeugeborenenVornamenKantonStgallenContext $ctx, string $fullurl, array $fetchdef): array
    {
