...
// NeugeborenenVornamenKantonStgallen SDK utility: make_options

class NeugeborenenVornamenKantonStgallenMakeOptions
{
    ...
    public static function call(NeugeborenenVornamenKantonStgallenContext $ctx): array
    {
        ...
        //
        // `NeugeborenenVornamenKantonStgallenSchema::optspec()` is built from the model:
        ...
        $optspec = NeugeborenenVornamenKantonStgallenSchema::optspec();
