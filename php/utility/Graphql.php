...
// NeugeborenenVornamenKantonStgallen SDK utility: graphql
//
...
class NeugeborenenVornamenKantonStgallenGraphql
{
    ...
    // equivalent.
    public static function body(NeugeborenenVornamenKantonStgallenContext $ctx): mixed
    {
    ...
    public static function errors(NeugeborenenVornamenKantonStgallenContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
