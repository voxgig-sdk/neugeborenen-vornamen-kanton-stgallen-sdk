...
class NeugeborenenVornamenKantonStgallenFeatures
{
    public static function make_feature(string $name)
    {
        switch ($name) {
            ...
            case "ratelimit":
                return new NeugeborenenVornamenKantonStgallenRatelimitFeature();
            case "retry":
                return new NeugeborenenVornamenKantonStgallenRetryFeature();
            case "test":
                return new NeugeborenenVornamenKantonStgallenTestFeature();
            case "timeout":
                return new NeugeborenenVornamenKantonStgallenTimeoutFeature();
            default:
                return new NeugeborenenVornamenKantonStgallenBaseFeature();
        }
    }
