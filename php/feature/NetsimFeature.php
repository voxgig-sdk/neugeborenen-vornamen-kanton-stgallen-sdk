...
// NeugeborenenVornamenKantonStgallen SDK netsim feature
...
class NeugeborenenVornamenKantonStgallenNetsimFeature extends NeugeborenenVornamenKantonStgallenBaseFeature
{
    ...
    private function _simulate(NeugeborenenVornamenKantonStgallenContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NeugeborenenVornamenKantonStgallenContext $ctx, array $applied): void
    {
        $client = $this->client;
