...
// NeugeborenenVornamenKantonStgallen SDK rbac feature
...
class NeugeborenenVornamenKantonStgallenRbacFeature extends NeugeborenenVornamenKantonStgallenBaseFeature
{
    ...
    private function _required(NeugeborenenVornamenKantonStgallenContext $ctx): ?string
    {
    ...
    private function _reject(NeugeborenenVornamenKantonStgallenContext $ctx, string $required): void
    {
    ...
    private function _track(NeugeborenenVornamenKantonStgallenContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
