# NeugeborenenVornamenKantonStgallen PHP SDK



The PHP SDK for the NeugeborenenVornamenKantonStgallen API — an entity-oriented client using PHP conventions.
...
print_r(array_map(fn($item) => $item->data_get(), $metadata));
```
...
```
php/
├── neugeborenenvornamenkantonstgallen_sdk.php          -- Main SDK class
...
The main class (`neugeborenenvornamenkantonstgallen_sdk.php`) exports the SDK class
